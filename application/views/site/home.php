			...
			<div class="col-md-12 mr-auto ml-auto text-center">
				<div class="card-columns">
					...
					<div class="card card-body">
						<h2>Segunda-Feira</h2>
						<ul>
							<li>Calulu de carne seca</li>
							<li>Beef a parmegiana</li>
							<li>Peixe escalado ao molho de alho</li>
							<li>Filetes com arroz de tomate</li>
						</ul>
						<h3>Sobremesa</h3>
						<ul>
							<li>Cheescake</li>
							<li>Frutas laminadas</li>
							<li>Bolos sortidos</li>
						</ul>
					</div>
					...
					<div class="card card-body">
						<h2>Terça-Feira</h2>
						<ul>
							<li>Rabinho de boi</li>
							<li>Leitão a bairrada</li>
							<li>Cozido de corvina</li>
							<li>Lulas recheadas ao molho do chef</li>
						</ul>
						<h3>Sobremesa</h3>
						<ul>
							<li>Moisse de limão</li>
							<li>Bolos sortidos</li>
							<li>Frutas laminadas</li>
						</ul>
					</div>
					...
					<div class="card card-body">
						...
						<ul>
							...
							<li>Grelhada mista</li>
							<li>Bagre fumado</li>
							<li>Caldeirada de peixe</li>
						</ul>
						<h3>Sobremesa</h3>
						<ul>
							<li>Cerradura</li>
